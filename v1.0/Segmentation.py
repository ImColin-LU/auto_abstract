...
class WordSegmentation(object):#这里进行分词，使用jieba进行分词
    ...
    def segment(self, text, lower=True, use_stop_words=True, use_speech_tags_filter=False):#这里对文本进行分词
    ...
    def segment_sentences(self, sentences, lower=True, use_stop_words=True, use_speech_tags_filter=False):#将分词后的语句构建成列表
        """
...
class SentenceSegmentation(object):#对文本进行分句
